...
1. First build a container from the [`Dockerfile`](https://github.com/MareGraph-EU/aphia-ldes-mirror/blob/main/pipeline/Dockerfile) present in this repository:
